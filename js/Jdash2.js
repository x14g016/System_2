...
// 画像
	...
	//ボタン生成
	var buttonA = new Button(btnStr[btr_Ai],"dark",11,25);
	var buttonB = new Button(btnStr[btr_Bi],"dark",21,25);
	var buttonC = new Button(btnStr[btr_Ci],"dark",31,25);
	var buttonD = new Button(btnStr[btr_Di],"dark",41,25);
	var buttonE = new Button(btnStr[btr_Ei],"dark",51,25);
	/*
	 * 汎用処理
	 */
	// ランダム値生成
			...
			window.location.href = 'https://www.google.co.jp/';
				...
				function input(){
					...
					scene.addChild(input);
				 	...
				 	//ボタン
				 	function button(){
				 		addButton(buttonA,300,200);
				 		addButton(buttonB,250,200);
				 		addButton(buttonC,200,200);
				 		addButton(buttonD,150,200);
				 		addButton(buttonE,100,200);
		       	}
